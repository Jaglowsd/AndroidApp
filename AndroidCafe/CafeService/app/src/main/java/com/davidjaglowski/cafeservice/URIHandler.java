...
public class URIHandler {
    ...
    public static String doGet(String uri,String failure) throws IOException {
        ...
        try {
            ...
            Log.d("CafeService","Received: " + result);
            return result;

        } catch(Exception ex) {
            Log.d("CafeService", "Exception in doGet:" + ex.toString());
        } finally {
            if (is != null) {
                is.close();
            }
    ...
    public static String doPost(String uri, String data) throws IOException {
        ...
        try {
            Log.d("CafeService", "Post uri: " + uri);
            URL url = new URL(uri);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
            ...
            Log.d("CafeService","Exception in doPost:" + ex.toString());
        } finally {
            if (is != null) {
                is.close();
            }
    ...
    public static String doPut(String uri, String data) throws IOException {
        ...
        try {
            Log.d("CafeService", "Put uri: " + uri);
            Log.d("CafeService", "Put data: " + data);
            URL url = new URL(uri);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
            ...
            Log.d("CafeService","PUT response: "+ responseCode);
            return result;
        } catch(Exception ex) {
            Log.d("CafeService","Exception in doPut:" + ex.toString());
        }
        return "";
    }
    ...
    public static void doDelete(String uri) throws IOException {
        try {
            Log.d("CafeService", "DELETE uri: " + uri);
            URL url = new URL(uri);
            HttpURLConnection conn = (HttpURLConnection) url.openConnection();
            ...
            conn.connect();
            int responseCode = conn.getResponseCode();
            Log.d("CafeService","DELETE response: "+responseCode);
        } catch (Exception ex) {
            Log.d("cafeService","Exception in doDelete:" + ex.toString());
        }
    }
